...
def generate_launch_description():
    ...
    # Launching simulation with Gazebo Garden multi-vehicle approach
    ld.add_action(
        Node(
            ...
            parameters=[{
                'nb_vehicles': nb_drones,
                'drone_model': 'gz_x500',  # Can be made configurable
                'world': 'warehouse',  # Can be made configurable
